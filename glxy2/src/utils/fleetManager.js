...
export class FleetManager {
  ...
  initializeStartingFleet() {
    ...
    console.log('Initializing starting fleet for system:', startingSystemId); // ADDED
    
    if (startingSystemId !== null) {
      const scout = this.createShip('scout', 'Scout Alpha', startingSystemId);
      console.log('Created scout:', scout); // ADDED
      this.addShipToSystem(scout, startingSystemId);
      console.log('Added scout to system:', startingSystemId); // ADDED
      
      const scout2 = this.createShip('scout', 'Scout Beta', startingSystemId);
      console.log('Created scout2:', scout2); // ADDED
      this.addShipToSystem(scout2, startingSystemId);
      console.log('Added scout2 to system:', startingSystemId); // ADDED
  ...
  addShipToSystem(ship, systemId) {
    // Ensure the star system exists
    if (!this.stars[systemId]) {
  ...
  // Check if there are any moving fleets
  hasMovingFleets() {
